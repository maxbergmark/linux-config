...
prompt() {
    ...
    my_ps_host_root="${bold_green}\h${normal}";
    ...
    case "`id -u`" in
        ...
        ;;
        *) PS1="\r\n${TITLEBAR}╭─$(my_ve)$(chroot)[${bold_light_blue}\t${normal}][$my_ps_user][$my_ps_host]$(modern_scm_prompt)$(__my_rvm_ruby_version)[${bold_light_cyan}\w${normal}]$(is_vim_shell)\r\n╰╼ "
        ;;
    esac
}
#╴├
